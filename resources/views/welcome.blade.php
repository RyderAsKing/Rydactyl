@extends('layout.app')
@section('navbar')
<!-- To remove navbar from the home page -->@endsection
...
@section('footer')
<!-- To remove navbar from the home page -->
@endsection
@section('content')
        ...
        <div class="inner">
                ...
                <div class="wrapper">
                    <div class="inner">
                        <div>
                            ...
                            <p id="text58" class="style6">With {{ env('APP_NAME') }} you can host your server with no
                                hidden charges.</p>
                        </div>
                        <div>
                            <h2 id="text60" class="style3">High speed RAM</h2>
                            <p id="text66" class="style6">We provide free 2 GB DDR4 fast memory for your free server.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div id="container14" class="container default full">
                <div class="wrapper">
                    <div class="inner">
                        ...
                        <p id="text22" class="style4">We display ads on our website which in turn gives us funds which
            ...
            <div id="container05" class="container columns full">
                <div class="wrapper">
                    <div class="inner">
                        <div>
                            <div id="image04" class="style2 image"><img src={{ asset('images/landing.svg') }} alt="">
                            </div>
                        </div>
                        <div>
                            <h2 id="text37" class="style2">Why do we do this?</h2>
                            <p id="text21" class="style6">Simply because we know that not every one can afford a premium
            ...
            <div id="container03" class="container default full">
                <div class="wrapper">
                    <div class="inner">
                        ...
                        <p id="text27" class="style4">Just do not block the ads ;(, we are only able to continue running
